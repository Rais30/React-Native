...
class DzikirPetang extends React.Component {
  state = {
    ...
    },
    {
      ...
      terjemahan:'“Aku memohon ampun kepada Allah dan bertobat kepada-Nya.” (Dibaca 100 x dalam sehari)[18]',
    },
  ],
};
render() {
      ...
      <ScrollView style={{flex: 1}}>
        {this.state.data.map((value, key) => {
          ...
          if (valueKey % 2 == 0) {
            ...
            return (
              <View
                style={{...styles.boxContent, backgroundColor: '#E7FFA2'}}
                key={key}>
                <View style={styles.boxLafaldz}>
                  <Text style={styles.textLafaldz}>{value.lafaldz}</Text>
                </View>
